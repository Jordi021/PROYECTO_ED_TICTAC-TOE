            ...
            for (int j = 0; j < n; j++) {
                ...
                boton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        // Ahora tienes las coordenadas (fila, columna) del botón
                        // Hacer algo con ellas, como guardarlas en variables o llamar a un método aparte
